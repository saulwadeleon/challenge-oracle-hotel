...
public class MenuUsuario extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					MenuUsuario frame = new MenuUsuario(conexion); // Pasa la instancia a MenuUsuario
	...
	public MenuUsuario(ConnectionFactory conexion) {
		...
		JPanel btnHuesped = new JPanel();
		btnHuesped.setLayout(null);
		btnHuesped.setBackground(new Color(12, 138, 199));
		btnHuesped.setBounds(0, 312, 257, 56);
		panelMenu.add(btnHuesped);

		JLabel labelHuesped = new JLabel("Registro de huespedes");
		labelHuesped.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/persona.png")));
		labelHuesped.setHorizontalAlignment(SwingConstants.LEFT);
		labelHuesped.setForeground(SystemColor.text);
		labelHuesped.setFont(new Font("Dialog", Font.PLAIN, 18));
		labelHuesped.setBounds(15, 11, 225, 34);
		btnHuesped.add(labelHuesped);
		...
		btnHuesped.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHuesped.setBackground(new Color(118, 187, 223));
			}
		...
		btnBuscar.setBounds(0, 368, 257, 56);
		btnBuscar.setBackground(new Color(12, 138, 199));
