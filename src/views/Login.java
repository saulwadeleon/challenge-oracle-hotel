...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtContrasena.putClientProperty("JPasswordField.placeholderText", "********");
		...
		btnEntrar.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					// Realizar la acción deseada, en este caso, abrir el menú de usuario
					acceso();
				}
			}
		});
	...
	private void acceso() {
		...
		LoginController loginController = new LoginController(connectionFactory);
		if (loginController.autenticarUsuario(nombreUsuario, contraseña)) {
			// Las credenciales son válidas, abre el menú de usuario.
			MenuUsuario menu = new MenuUsuario(connectionFactory);
